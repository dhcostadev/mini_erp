...
if ($action === 'get_address' && $_SERVER['REQUEST_METHOD'] === 'POST') {
    $cartController = new CartController();
    header('Content-Type: application/json');
    echo json_encode($cartController->getAddressByCep($_POST['cep']));
    exit;
}
...
<body>
    <div class="container">
        ...
        <form action="index.php?action=create" method="POST" class="mb-4">
            <div class="mb-3">
                ...
                <?php foreach ($products as $product): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="cart/index.php?action=add_to_cart&id=<?php echo $product['id']; ?>&variation_id=<?php echo $product['stock_id']; ?>" class="btn btn-success">Comprar</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
